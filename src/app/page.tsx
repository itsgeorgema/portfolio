...
export default function Home() {
  return (
    <div className="grid grid-rows-[1fr-auto] min-h-screen p-8 pt-20 gap-16 bg-nardo-500 relative overflow-hidden">
      <Navbar />
      ...
      <main className="flex items-end justify-start relative z-10 pb-30">
